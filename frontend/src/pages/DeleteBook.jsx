  ...
  return (
    <div className='p-8'>
      ...
      <div className="flex flex-col items-center border-2 border-sky-400 rounded-xl w-[600px] mx-auto p-8">
        ...
        <button onClick={handlDelete} className='bg-red-500 text-white rounded-xl text-2xl p-2 mt-4 w-full'>Yes, Delete it</button>
        <button onClick={() => navigate('/')} className=' w-full bg-green-500 rounded-xl text-white p-2 mt-4'>No, Cancel</button>
        </div>
      </div>
    </div>
  )
